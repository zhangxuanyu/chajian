...
var count_point = {
  ...
  return count;
    ...
    aa= '<div onmousedown="jpto(event)" style="width: '+width1+'px;height: '+height1+'px;background-color:rgba(255,'+green+',100,0.2) ;border-radius: 50%;text-align:center;"><input type="hidden" name="" id="" value="['+x+','+y+','+z+']"/>'+num+'</div>';  
      return aa
   ...
   render_sl:function (arr,x1,x2,y1,y2){
   	var arrsl=[ ];
   	if(x1>x2){
        var a;
        a = x1;
...
{num:1,x:148.09, y:167.32, z:85.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:148.09, y:167.32, z:85.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-28.09, y:-27.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-38.09, y:-32.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-28.09, y:-127.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-228.09, y:-127.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-110.09, y:-117.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-118.09, y:-137.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-148.09, y:-167.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-228.09, y:-137.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-58.09, y:-257.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-68.09, y:-57.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-118.09, y:-97.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-128.09, y:-117.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-218.09, y:-97.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-98.09, y:-127.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-78.09, y:-157.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:-88.09, y:-207.32, z:55.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:148.09, y:-167.32, z:85.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:28.09, y:-27.32, z:85.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:38.09, y:-32.32, z:85.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
{num:1,x:28.09, y:-127.32, z:85.98,the_mark:"<div style='background:url(image/DefaultIcon.png); background-position:center left; background-repeat: no-repeat; height:16px;line-height:10px;'><span style='margin-left:16px; font-size:9px; white-space: nowrap;'>" + "端点1" + "</span></div>"},
      ...
      for(;i<len;i++){
        if(arrr[i].num || arrr[i].num.length>0){
          if(typeof(arrr[i].num)=="number"){
          	//对最大值为2的进行散开渲染
          	if(arrr[i].getUpc==5){
          		var arr_sl = count_point.render_sl(arr,arrr[i].beginx,arrr[i].endx,arrr[i].beginy,arrr[i].endy);
          		console.log(arr_sl);
          		for(var j = 0;j<arr_sl.length;j++){
          			console.log(arr_sl[j]);
          		mt = "mt"+n1;
          		bt_Plug_Annotation.setAnnotation(mt,arr_sl[j].x,arr_sl[j].y, arr_sl[j].z, 0, 0, arr_sl[j].the_mark, true);
          		endn1 = n1;
          		n1++;
          		}
          	}else if(arrr[i].num==1){
...
//移除标记点的渲染
	...
	function jpto(event){
		...
		//jpt[2] = count_point.getZ(jpt[0],jpt[1],9000,jpt[0],jpt[1],-9000);
		console.log(jpt);
